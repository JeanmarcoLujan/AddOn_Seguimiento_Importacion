...
{
    class EditText_txtTrans : B1Item
    {
        public EditText_txtTrans()
        {
            FormType = "2009032023";
            ItemUID = "txtTrans";
        }
        ...
        public virtual void OnAfterChooseFromList(ItemEvent pVal)
        {
            ...
            Form.DataSources.DBDataSources.Item(0).SetValue("U_MGS_CL_TRANSPO", 0, cardCode);
            Form.DataSources.DBDataSources.Item(0).SetValue("U_MGS_CL_TRANAM", 0, cardName);
        ...
        {
            Form = new B1Forms(pVal.FormUID);
            if (string.IsNullOrEmpty(Form.DataSources.DBDataSources.Item(0).GetValue("U_MGS_CL_TRANSPO", 0)))
            {
                Form.DataSources.DBDataSources.Item(0).SetValue("U_MGS_CL_TRANAM", 0, "");
            }
